...
class Logo extends Phaser.Group {
	...
	animate(lose) {
		...
		var scaleTween = this.game.add.tween(this.logo.scale).to({x: [newScale, newScale*1.2, newScale], y: [newScale, newScale*.8, newScale]}, 1000, Phaser.Easing.Quadratic.InOut, true, 0);
